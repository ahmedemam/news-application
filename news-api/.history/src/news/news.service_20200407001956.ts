...
export class NewsService {
    ...
    public async getAllArticlesUserConfiguration(sources: any){
        return this.httpService.get(`${NEWS_API_CONFIG.NEWS_API_URL}/top-headlines?category=${sources.category}&language=${sources.language}&country=${sources.country}&apiKey=${NEWS_API_CONFIG.API_KEY}`).subscribe(e => {
            console.log(e)
            return e;
        }, (er)=> {
            console.log(er);
