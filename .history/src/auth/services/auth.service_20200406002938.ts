...
export class AuthService {
    ...
    public async register(createUserDTO: CreateUserDTO) {
        ...
        const hashedPassword = this.hashPassword(createUserDTO.password).then(hashedPassword => hashedPassword);
    ...
    public async comparePassword(passwordAttempt: string, user: User) {
