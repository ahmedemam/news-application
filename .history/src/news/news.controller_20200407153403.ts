import { Controller, Get, UseGuards, Req, Res, HttpStatus, Param, Body } from '@nestjs/common';
...
export class NewsController {
    ...
    @Get('/articles')
    // @UseGuards(AuthGuard())
    public async getAllArticlesByUserConfiguration(@Res() response , @Body('userID',  new ValidateObjectId()) userID) {
