...
export class NewsService {
    ...
    public async getAllArticlesUserConfiguration(sources: Sources){
        return this.httpService.get(`${NEWS_API_CONFIG.NEWS_API_URL}/everything?category=${sources.category}&language=${sources.language}&country=${sources.country}&apiKey=${NEWS_API_CONFIG.API_KEY}`);
    }
